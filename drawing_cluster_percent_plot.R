...
freq_table3 <- prop.table(x = table(Epi.integrated@active.ident, Epi.integrated@meta.data[, "group_id"]), margin = 1)
freq_table4 <- melt(freq_table3)
colnames(freq_table4)  <- c('cluster_id','group_id','freq')
